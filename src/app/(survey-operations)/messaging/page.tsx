import MessagingWorkspace from "@/components/testflighthub/MessagingWorkspace";
import SurveyOperationsShell from "@/components/testflighthub/SurveyOperationsShell";

export default function MessagingPage() {
  return (
    <SurveyOperationsShell mode="internal" title="Messaging" subtitle="Internal Operations">
