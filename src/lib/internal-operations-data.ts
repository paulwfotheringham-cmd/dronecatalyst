...
export const internalHomeTiles = [
  {
    ...
    title: "Clients",
    description: "Manage client accounts, contracts, and billing contacts.",
    accent: "from-sky-500/20 to-blue-600/10 border-sky-400/30",
  },
  {
    view: "assets" as const,
    title: "Assets",
    description: "Matrice 4T fleet registry across Barcelona, Porto, and Oxford.",
    accent: "from-violet-500/20 to-indigo-600/10 border-violet-400/30",
  },
  {
    view: "testing" as const,
    title: "Testing",
    description: "FlightHub simulator, live telemetry, and flight path validation.",
    accent: "from-emerald-500/20 to-teal-600/10 border-emerald-400/30",
  },
  {
    view: "live-projects" as const,
    title: "Live Projects",
    description: "Active field operations, progress, and assigned airframes.",
  ...
  },
  {
    ...
    description: "Real-time drone OSD feed and telemetry dashboard.",
